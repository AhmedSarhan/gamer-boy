...
export function GameActions({
  ...
  const [isFav, setIsFav] = useState(() => isFavorite(gameDbId));
  ...
  const toggleFavorite = () => {
    if (isFav) {
      removeFavorite(gameDbId);
      setIsFav(false);
    } else {
      addFavorite(gameDbId);
      setIsFav(true);
      setIsAnimating(true);
          ...
          <div className="absolute right-0 z-10 mt-2 w-56 rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
            <div className="p-2">
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left text-sm transition-colors hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
